export const projetosData = [
    {
        ...
        linkGithub: "https://github.com/caarlosandree/meu-portfolio-react",
    },
    {
    ...
    {
        nome: "Base de Conhecimento Centralizada",
        descricao: "Uma solução de base de conhecimento versátil, projetada para qualquer cenário ou empresa que necessite centralizar e gerenciar sua documentação interna. Oferece funcionalidades de busca, filtragem por categoria e interação com uma IA (Google Gemini) para prover respostas rápidas e contextualizadas, utilizando uma base de dados Strapi. O objetivo é otimizar o acesso à informação, acelerar o fluxo de trabalho e fornecer suporte eficiente.",
        tecnologias: ["React", "TypeScript", "CSS", "Node.js", "Strapi", "PostgreSQL", "Google Gemini API", "Docker", "Git"],
        linkGithub: "https://github.com/caarlosandree/base-de-conhecimento",
    }
];