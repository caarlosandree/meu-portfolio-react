        ...
        <>
            ...
            <section className="container">
                ...
                <ul>
                    ...
                    <li><strong>Linguagens:</strong> HTML5, CSS3, JavaScript, Python, C, C++, C#, Angular</li> {/* Adicionado Angular aqui */}
                    <li><strong>Frameworks/Bibliotecas Front-end:</strong> React, Vite, React Router DOM</li> {/* Nova categoria para clareza */}
                    ...
                    <li><strong>Outros:</strong> GitHub Pages</li> {/* GitHub Pages também pode ser listado aqui */}
                </ul>
            </section>
        </>
    );
